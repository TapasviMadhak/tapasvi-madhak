...
function ProjectsSection({ projects, fadeInUp }) {
  return (
    <section id="projects" className="mx-auto w-[min(1120px,92%)] py-8">
      ...
      <div className="elegant-scrollbar mt-5 h-[460px] overflow-y-auto pr-2">
        <div className="grid auto-rows-fr gap-5 md:grid-cols-2">
          {projects.map((project, index) => (
            <motion.article
              ...
              className="flex h-[220px] flex-col rounded-2xl border-2 border-black bg-cyber-card p-6 shadow-brutal transition hover:-translate-x-1 hover:-translate-y-1"
            >
              ...
              <p className="mt-2 line-clamp-3 text-sm text-cyber-slate">{project.text}</p>
